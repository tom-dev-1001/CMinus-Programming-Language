...
pub fn getValueNodeFloat(allocator:Allocator, ast_data:*ASTData) !*ASTNode {
...
pub fn processFloatDeclaration(allocator:Allocator, ast_data:*ASTData, first_token:Token, is_const:bool) AstError!*ASTNode {
    ...
    const valueNode:*ASTNode = try getValueNodeFloat(allocator, ast_data);
